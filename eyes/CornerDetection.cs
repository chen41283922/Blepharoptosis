...
namespace eyes
{
    class CornerDetection
    {
        ...
        public void VPF(String LorR ,out Rectangle PupilROI,out Rectangle CornerL_ROI,out Rectangle CornerR_ROI, out Image<Bgr,byte> Pupil) {
